...
@section('conteudo')
    ...
    <div class="container py-5">
        <a href="{{ route('pedidos.create') }}" class="btn btn-primary shadow-sm">
            <i class="bi bi-plus"></i> Add Pedido
        </a>
            ...
            <tbody>
                @foreach ($pedidos as $pedido)
                    <tr>
                        ...
                        <td><a href="{{ route('pedidos-produtos.create', ['pedido_id' => $pedido->id]) }}">Add Produtos</a></td>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal"
                                onclick="setDeleteUrl('{{ route('pedidos.destroy', $pedido->id) }}')">Excluir</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <div style="display: flex; justify-content: center; margin-top: 100px;">
        {{ isset($request) ? $pedidos->appends($request)->links('pagination::bootstrap-4') : $pedidos->links('pagination::bootstrap-4') }}
    </div>
    <br>
